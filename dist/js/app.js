(() => {
    ...
    function filterInit() {
        if (document.querySelector(".filter-categories")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".filter-categories")) {
                bodyLockToggle();
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swiper__releted-products")) new swiper_core_Swiper(".swiper__releted-products", {
    ...
    const rangeInput = document.querySelectorAll(".range-input input"), priceInput = document.querySelectorAll(".price-input input"), range = document.querySelector(".price-slider .price-slider__progress");
    let priceGap = 1;
    priceInput.forEach((input => {
        input.addEventListener("input", (e => {
            let minPrice = parseInt(priceInput[0].value), maxPrice = parseInt(priceInput[1].value);
            if (maxPrice - minPrice >= priceGap && maxPrice <= rangeInput[1].max) if (e.target.className === "price-input__min") {
